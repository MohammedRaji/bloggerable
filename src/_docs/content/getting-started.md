...
10. Edit `src/_docs/content/getting-started.md`: remove this section (Step by Step Tutorial).
...
- Do not edit the existing docs in `src/_docs/content`.
- Under the `src/_docs/content`, create a new Markdown (`.md`) file, the file are named using the format:
  - `[category].md` - index for this `category` (optional)
  - `[category]-[title].md`
  - `[category]-[subcategory].md` - index for this `subcategory` (optional)
  - `[category]-[subcategory]-[title].md`
- You must manually add the link to the document navigation in `src/_docs/templates/partials/doc-nav.html`.
- Learn more from the existing source in `src/_docs`.

Example:

```yaml
# src/_docs/content/foo.md (index for "Foo" category)
...
```yaml
# src/_docs/content/foo-bar-one.md
...
```yaml
# src/_docs/content/foo-bar-two.md
...
```html
# src/_docs/templates/partials/doc-nav.html

<nav class="doc-nav">
  <div class="doc-nav-wrap">

    <h6 class="doc-nav-category">Foo</h6>
    <a class="doc-nav-link" href="foo.html">Overview</a>
    <h6 class="doc-nav-subcategory">Bar</h6>
...
- [Document](#create-a-new-document) the component in `src/_docs`.
- Learn more from the existing source in `src/_scss` and `src/_docs`.

### Rewrite the main CSS in `src/_scss`

- Remove all Sass files and folder in `src/_scss` except `index.scss`.
- Remove the docs `src/_docs/content/css-*.md` and its navigation link in `src/_docs/templates/partials/doc-nav.html`.
- Create your own styles in `src/_scss`, import your styles to `src/_scss/index.scss`. 
- [Document](#create-a-new-document) your styles in `src/_docs`.
- Learn more from the existing source in `src/_scss` and `src/_docs`.
...
To update your theme to the latest major version of Bloggerable (e.g., Bloggerable `v2.0.0`), please re-download Bloggerable `v2.0.0` and re-create your theme in Bloggerable `v2.0.0`.
